          ...
          <div className="space-y-6 animate-slide-in">
            ...
            <div className="bg-white p-6 rounded-[32px] border shadow-sm">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                 <a href="https://squoosh.app" target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 rounded-2xl bg-orange-50 border border-orange-100 hover:bg-orange-100 transition group">
                    <div className="bg-orange-500 p-3 rounded-xl text-white shadow-md group-hover:scale-110 transition"><Zap size={20}/></div>
                    <div>
                      <p className="font-black text-[10px] text-orange-600 uppercase">Squoosh</p>
                      <p className="text-[9px] font-bold text-orange-400">Ver Antes/Depois</p>
                    </div>
                 </a>
                 <a href="https://www.iloveimg.com/pt/comprimir-imagem" target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 rounded-2xl bg-blue-50 border border-blue-100 hover:bg-blue-100 transition group">
                    <div className="bg-blue-500 p-3 rounded-xl text-white shadow-md group-hover:scale-110 transition"><ImageIcon size={20}/></div>
                    <div>
                      <p className="font-black text-[10px] text-blue-600 uppercase">Diminuir Muitas</p>
                      <p className="text-[9px] font-bold text-blue-400">iLoveIMG</p>
                    </div>
                 </a>
                 ...
                 <a href="https://www.canva.com" target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 rounded-2xl bg-teal-50 border border-teal-100 hover:bg-teal-100 transition group">
                    ...
                    <div>
                      <p className="font-black text-[10px] text-teal-600 uppercase">Canva</p>
                      <p className="text-[9px] font-bold text-teal-400">Criar Banners</p>
                    </div>
                 </a>
               </div>
               <p className="mt-6 text-center text-[9px] font-black text-gray-300 uppercase tracking-widest">💡 Silvia, o Squoosh é o que você mais gosta para ver a qualidade!</p>
            </div>
          </div>
        )}
